...
3. **"If downlevelled" plan**: accept if comp is fair, negotiate 6-month review, clear criteria
...
| 5 | status | canonical | `Evaluated` | MUST be canonical (see states.yml) — use English labels |
