...
4. **Generate message** with 3-sentence framework adapted to the contact type:
   ...
   ### Hiring Manager
   - **Sentence 1 (Hook)**: Specific challenge facing their team (extracted from JD, company blog, or news)
   - **Sentence 2 (Proof)**: Candidate's greatest quantifiable achievement demonstrating similar problem-solving
   ...
   - **Sentence 1 (Research)**: Reference to something specific about their work or career
...
5. **Versions**:
   - EN (default)
   - ES (if Spanish-language company)
